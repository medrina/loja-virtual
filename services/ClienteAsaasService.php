<?php
    class ClienteAsaasService {
        ...
        // cria um novo cadastro salvando a FK da tabela cliente
        public function criarCadastro(): bool {
            try {
        ...
        // edita/atualiza cpf e telefone do Usuário Cliente
        ...
        // recupera cpf e telefone do Usuário Cliente
        public function getClienteAsaas(): array {
            try {
