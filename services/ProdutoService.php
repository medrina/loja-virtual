<?php
    class ProdutoService {
        ...
        // método responsável por consultar e recuperar um Produto pelo seu id
        ...
        public function setProdutoBanco(): bool {
            $status1 = 'status';
            $status2 = ':status';
            try {
                $query = 'INSERT INTO
        ...
        // método responsável por alterar/atualizar os dados do Produto que já foi cadastrado
        public function atualizarProdutoBanco(): bool {
            try {
                $status = 'status';
        ...
        // método responsável que altera/atualiza o (novo) nome do arquivo de imagem que foi substituído
        public function atualizarImagemBanco($imagem, $id_produto): bool {
            try {
        ...
        // método responsável que consulta e recupera a lista de Produtos segundo a sua Subcategoria informada
        public function getListaProdutosPorMarca(): array {
            try {
                $status = 'status';
        ...
        // método responsável que consulta e recupera a lista de Produtos pela opção de maior/menor faixa de preços
        public function maiorMenorPreco($opcao): array {
            try {
                $status = 'status';
