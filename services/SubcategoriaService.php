<?php
    class SubcategoriaService {
        ...
        // método responsável que consulta e recupera todas as Subcategorias
        ...
        // retorna lista de produtos pelo id da subcategoria e pelo "status" do produto (se o produto está ativado ou não para exibição)
        ...
        // método responsável que cadastra uma nova Subcategoria
        public function salvarSubCategoria(): int {

            // conta quantos registros existe dessa Subcategoria informada pelo Usuário Administrador na tabela subcategoria do banco de dados
            try {
            ...
            // verifica se a Subcategoria já foi cadastrada (para impedir que a Subcategoria seja cadastrada novamente)
            if($resultado['quant']) return 1;

            // continua o fluxo normal de cadastrar uma nova Subcategoria
            else {

                // cadastra a nova Subcategoria na tabela subcategoria
                try {
        ...
        // método responsável que altera/atualiza o novo nome da Subcategoria informada pelo Usuário Administrador
        public function atualizarSubCategoria(): bool {
            try {
