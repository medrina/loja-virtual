<?php
    class PedidoService {
        ...
        // método responsável por consultar e retornar uma lista de Pedidos desse Usuário Cliente
        ...
        // método responsável que consulta e retorna um Pedido pelo seu id, desse Usuário Cliente
        ...
        // método responsável por consultar e recuperar os Pedidos por uma data específica selecionada pelo Usuário Administrador
        public function getPedidosPorDiaMesAno(): array {
        ...
        // método responsável por alterar o status de entrega pelo Usuário Administrador, referente ao Pedido do Usuário Cliente
        public function atualizarStatusPedidoEntrega(string $st, int $id_pedido): bool {
            $status = 'status';
            try {
