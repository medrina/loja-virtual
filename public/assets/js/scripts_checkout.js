$(document).ready(function () {
                ...
                if(response == 0) window.location.assign('/cliente/painel?erro=3')
                    ...
                    $.ajax({
                        ...
                        success: (resposta) => {
                            ...
                            $('.mascara-entrega').css('height', pag)
                            if(largura > 1399) {
                                $('.mascara-pagamento').css('bottom', '510px')
                            }
                            else if(largura >= 1200 && largura <= 1399) {
                                $('.mascara-pagamento').css('bottom', '528px')
                            }
                            else if(largura >= 992 && largura <= 1199) {
                                $('.mascara-pagamento').css('bottom', '546.5px')
                            }
                            else if(largura >= 768 && largura <= 991) {
                                $('.mascara-pagamento').css('bottom', '582px')
                            }
    ...
    $('#gerar-cod-pix').on('click', () => {
        ...
        setTimeout(() => {
            $('#resp-codigo-pix').html(`<p><b>Código abaixo:</b><br><span id="cod-pix">${codigoPix}</span></p><div><p>Copiar Pix: <a id="copiar_cod_pix" href="#gerar-cod-pix" onclick="copiarCodPix()"><i id="icone-copiar-pix" class="fa-solid fa-copy fa-beat" title="Código PIX"></i></a></p></div>`)
                    ...
                    $.ajax({
                        ...
                        success: (resposta) => {
                            if(resposta) {
                                ...
                                if((largura4 > 1399) ||
                                    (largura4 >= 1200 && largura4 <= 1399) ||
                                    (largura4 >= 992 && largura4 <= 1199) ||
                                    (largura4 > 768 && largura4 <= 991)) {
                                        $('.mascara-pagamento').css('bottom', '515px')
                                }
