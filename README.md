   ...
   - MVC
      - Backend:
         - Camada dos Controladores (Controllers)
            - Classes responsáveis por receber/retornar os dados contidos nas requisições HTTP ao frontend (e também via Ajax); encaminhar essas requisições para as Camadas dos Serviços (Services); e também instanciar os objetos da Camada dos Modelos (Models) quando necessários.
...
OBS.: Para acessar o Painel, ambos os tipos de usuários (cliente e administrador), precisam inicialmente, realizar o seu cadastro na tela de Cadastro, e efetuar o seu login na tela de Login.
--------------------------------------------------------------------------------
## Instruções de Uso
### 1) Instalações
...
----------------------------------------------------------------------------------
## 2) Criar o Banco de Dados e as Tabelas que compõem o funcionamento do Sistema:
...
-----------------------------------------------------------------------------------
## 3) Baixar o Projeto Loja Virtual do Git Hub
- Baixar e extraír a Loja Virtual no seu computador
-----------------------------------------------------------------------------------
## 4) Configurar informações do Banco de Dados MySQL no arquivo de configuração do Projeto Loja Virtual
